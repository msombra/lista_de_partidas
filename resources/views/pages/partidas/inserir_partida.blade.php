                    ...
                    <div class="card-body row">
                        ...
                        <div class="form-group col-12">
                            ...
                            <div class="form-check mt-2">
                                ...
                                <div>
                                    <input class="form-check-input" type="radio" id="nao_existente" name="tipo_adversario" onclick="mostrarCampoTexto()">
                                ...
                                <div>
                                    <input class="form-check-input" type="radio" id="existente" name="tipo_adversario" onclick="mostrarSelect()">
                        ...
                        <div class="form-group col-12 mt-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="partida_importante" name="partida_importante" value="1">
                                <label class="form-check-label" for="partida_importante">Selecione caso a partida seja importante.</label>
                            </div>
                        </div>
                    </div>
